...
from .catlist_screens import ClanScreen, StarClanScreen, DFScreen, ListScreen, AllegiancesScreen, MedDenScreen, OtherClan1Screen
...
other_clan_1_screen = OtherClan1Screen('other clan 1 screen')
