...
def create_other_clan_cat(Cat,
    ...
    for index in range(number_of_cats):
        ...
        new_cat.clan = str(game.otherclan1.name).removesuffix("Clan")
        ...
        game.clan.add_cat(new_cat)
        history = History()
        history.add_beginning(new_cat, clan_born=True)
...
def create_oc_existing_cat(Cat,
                   new_name=False,
                   loner=False,
                   kittypet=False,
                   kit=False,
                   ...
                   age=None,
                   gender=None,
                   thought='Is glad to be a part of the Clan',
                   alive=True,
                   outside=True
	):
    ...
    for index in range(number_of_cats):
        ...
        if backstory in (BACKSTORIES["backstory_categories"]["clanborn_backstories"]):
            history.add_beginning(new_cat, clan_born=True)
        else:
            history.add_beginning(new_cat, clan_born=False)
